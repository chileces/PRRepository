...
/**
 * Provides the base implementation for the persisted invoice line local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.training.service.impl.PersistedInvoiceLineLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.training.service.impl.PersistedInvoiceLineLocalServiceImpl
 * @generated
 */
public abstract class PersistedInvoiceLineLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PersistedInvoiceLineLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>PersistedInvoiceLineLocalServiceUtil</code>.
	 */
	...
	public PersistedInvoiceLine addPersistedInvoiceLine(
		...
		return persistedInvoiceLinePersistence.update(persistedInvoiceLine);
	}
	...
	public PersistedInvoiceLine createPersistedInvoiceLine(
		...
		return persistedInvoiceLinePersistence.create(persistedInvoiceLineId);
	}
	...
	public PersistedInvoiceLine deletePersistedInvoiceLine(
		...
		return persistedInvoiceLinePersistence.remove(persistedInvoiceLineId);
	}
	...
	public PersistedInvoiceLine deletePersistedInvoiceLine(
		...
		return persistedInvoiceLinePersistence.remove(persistedInvoiceLine);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			PersistedInvoiceLine.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return persistedInvoiceLinePersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return persistedInvoiceLinePersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public PersistedInvoiceLine fetchPersistedInvoiceLine(
		...
		return persistedInvoiceLinePersistence.fetchByPrimaryKey(
	...
	public PersistedInvoiceLine getPersistedInvoiceLine(
		...
		return persistedInvoiceLinePersistence.findByPrimaryKey(
			persistedInvoiceLineId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(PersistedInvoiceLine.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return persistedInvoiceLinePersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return persistedInvoiceLineLocalService.deletePersistedInvoiceLine(
			(PersistedInvoiceLine)persistedModel);
	}

	public BasePersistence<PersistedInvoiceLine> getBasePersistence() {
		return persistedInvoiceLinePersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return persistedInvoiceLinePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<PersistedInvoiceLine> getPersistedInvoiceLines(
		...
		return persistedInvoiceLinePersistence.findAll(start, end);
	}
	...
	public int getPersistedInvoiceLinesCount() {
		return persistedInvoiceLinePersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PersistedInvoiceLineLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		persistedInvoiceLineLocalService =
			(PersistedInvoiceLineLocalService)aopProxy;

		_setLocalServiceUtilService(persistedInvoiceLineLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return PersistedInvoiceLineLocalService.class.getName();
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				PersistedInvoiceLineLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, persistedInvoiceLineLocalService);
		}
	...
	protected PersistedInvoiceLineLocalService persistedInvoiceLineLocalService;
