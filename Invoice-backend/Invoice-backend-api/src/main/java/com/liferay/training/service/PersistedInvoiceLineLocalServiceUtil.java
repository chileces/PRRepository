...
/**
 * Provides the local service utility for PersistedInvoiceLine. This utility wraps
 * <code>com.liferay.training.service.impl.PersistedInvoiceLineLocalServiceImpl</code> and
 ...
 * @generated
 */
public class PersistedInvoiceLineLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.training.service.impl.PersistedInvoiceLineLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static PersistedInvoiceLine addPersistedInvoiceLine(
		...
		return getService().addPersistedInvoiceLine(persistedInvoiceLine);
	}
	 ...
	 */
	public static PersistedInvoiceLine createPersistedInvoiceLine(
		long persistedInvoiceLineId) {

		return getService().createPersistedInvoiceLine(persistedInvoiceLineId);
	}
	 ...
	 */
	public static void deleteAllInvoiceLineDetails(long persistedInvoiceId) {
		getService().deleteAllInvoiceLineDetails(persistedInvoiceId);
	}
	 ...
	 */
	public static PersistedInvoiceLine deletePersistedInvoiceLine(
			long persistedInvoiceLineId)
		throws PortalException {

		return getService().deletePersistedInvoiceLine(persistedInvoiceLineId);
	}
	...
	public static PersistedInvoiceLine deletePersistedInvoiceLine(
		...
		return getService().deletePersistedInvoiceLine(persistedInvoiceLine);
	}
	...
	public static PersistedInvoiceLine fetchPersistedInvoiceLine(
		long persistedInvoiceLineId) {

		return getService().fetchPersistedInvoiceLine(persistedInvoiceLineId);
	}
	 ...
	 */
	public static List<PersistedInvoiceLine> getAllPersistedInvoiceLine(
		long persistedInvoiceId, int start, int end) {

		return getService().getAllPersistedInvoiceLine(
	 ...
	 * @throws PortalException if a persisted invoice line with the primary key could not be found
	 */
	public static PersistedInvoiceLine getPersistedInvoiceLine(
			long persistedInvoiceLineId)
		throws PortalException {

		return getService().getPersistedInvoiceLine(persistedInvoiceLineId);
	}
	 ...
	 */
	public static List<PersistedInvoiceLine> getPersistedInvoiceLines(
		int start, int end) {

		return getService().getPersistedInvoiceLines(start, end);
	}
	 ...
	 */
	public static int getPersistedInvoiceLinesCount() {
		return getService().getPersistedInvoiceLinesCount();
	}
	 ...
	 */
	public static PersistedInvoiceLine updatePersistedInvoiceLine(
		PersistedInvoiceLine persistedInvoiceLine) {

		return getService().updatePersistedInvoiceLine(persistedInvoiceLine);
	}

	public static PersistedInvoiceLineLocalService getService() {
		return _service;
	}

	private static volatile PersistedInvoiceLineLocalService _service;
