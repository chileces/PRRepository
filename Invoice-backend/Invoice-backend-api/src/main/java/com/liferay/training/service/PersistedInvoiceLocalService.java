...
/**
 * Provides the local service interface for PersistedInvoice. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see PersistedInvoiceLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface PersistedInvoiceLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.training.service.impl.PersistedInvoiceLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the persisted invoice local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link PersistedInvoiceLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public PersistedInvoice createPersistedInvoice(long persistedInvoiceId);
	...
	public PersistedInvoice deletePersistedInvoice(
		PersistedInvoice persistedInvoice);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public PersistedInvoice fetchPersistedInvoice(long persistedInvoiceId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<PersistedInvoice> getPersistedInvoices(int start, int end);
