...
public class RegistrationLogPersistenceImpl
	 ...
	 */
	@Override
	public List<RegistrationLog> findByUserId(long userId) {
	 ...
	 */
	@Override
	public List<RegistrationLog> findByUserId(long userId, int start, int end) {
	 ...
	 */
	@Override
	public List<RegistrationLog> findByUserId(
	...
	public List<RegistrationLog> findByUserId(
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (RegistrationLog registrationLog : list) {
					if (userId != registrationLog.getUserId()) {
						list = null;
	...
	public RegistrationLog findByUserId_First(
		...
		RegistrationLog registrationLog = fetchByUserId_First(
	...
	public RegistrationLog fetchByUserId_First(
		...
		List<RegistrationLog> list = findByUserId(
	...
	public RegistrationLog findByUserId_Last(
		...
		RegistrationLog registrationLog = fetchByUserId_Last(
			userId, orderByComparator);
	...
	public RegistrationLog[] findByUserId_PrevAndNext(
		...
		try {
			...
			array[0] = getByUserId_PrevAndNext(
				session, registrationLog, userId, orderByComparator, true);

			array[1] = registrationLog;

			array[2] = getByUserId_PrevAndNext(
				session, registrationLog, userId, orderByComparator, false);
	...
	protected RegistrationLog getByUserId_PrevAndNext(
		Session session, RegistrationLog registrationLog, long userId,
		OrderByComparator<RegistrationLog> orderByComparator,
		boolean previous) {
