...
public class SearchUserPortletResourcePermissionDefinition implements PortletResourcePermissionDefinition {
	...
	public PortletResourcePermissionLogic[] getPortletResourcePermissionLogics() {
		...
		return new PortletResourcePermissionLogic[] { new StagedPortletPermissionLogic(_stagingPermission,
				"com_amf_web_registration_portlet_SearchPortlet") };
	}

	@Override
	public String getResourceName() {

		return RegistrationConstants.RESOURCE_USER_MODEL_NAME;
	}
