package com.liferay.training.headless.resource.v1_0;
 ...
 *
 *     curl -u your@email.com:yourpassword -D - http://localhost:8080/o/headless-invoice/v1.0
 *
 * @author ces-user
 * @generated
 */
...
public interface InvoiceResource {
	...
	public Response postInvoiceBatch(String callbackURL, Object object)
		throws Exception;

	public void deleteInvoice(Long invoiceId) throws Exception;

	public Response deleteInvoiceBatch(String callbackURL, Object object)
		throws Exception;
	...
	public Response putInvoiceBatch(String callbackURL, Object object)
		throws Exception;
